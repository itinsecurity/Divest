...
- After PR merge, delete the local head branch
...
4. **Create Pull Request** (Agent performs immediately):
   - Title format: `[Feature/Bugfix/Hotfix/Chore]: Description`
     - Examples: `[Feature]: Add user authentication`, `[Bugfix]: Fix login redirect loop`
   - Body must include: What changed, Why, How to test, Deployment notes (if applicable)
